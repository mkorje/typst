...
--- block-sticky-spill-finite-region paged ---
// Ensure that measuring a spilling breakable block for sticky migration does
// not expose an infinite region to nested layout callbacks.
#set page(height: 30pt, margin: 0pt)
#set block(width: 100%, spacing: 0pt, breakable: false)
...
#block(breakable: true)[
  ...
  #layout(size => assert(size.height < 100pt))
]
